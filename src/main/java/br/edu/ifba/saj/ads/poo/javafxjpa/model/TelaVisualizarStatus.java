...
public class TelaVisualizarStatus extends Application {

    private Stage primaryStage;

    public TelaVisualizarStatus() {
    ...
    public void exibirTelaVerificarStatusFila() {
        Label tituloLabel = new Label("Verificar Status da Fila");
        tituloLabel.setStyle("-fx-font-size: 24px; -fx-font-weight: bold; -fx-text-fill: white;");

        Label descricaoLabel = new Label("Clique no botão abaixo para verificar o status da fila:");
        descricaoLabel.setStyle("-fx-text-fill: white;");

        Button verificarStatusButton = new Button("Verificar Status");
        verificarStatusButton.setStyle("-fx-background-color: black; -fx-text-fill: white;");
        verificarStatusButton.setOnAction(e -> {
            voltarParaTelaAnterior();
            String url = "https://www.internacionaltravessias.com.br/filometro/#container";
        ...
        primaryStage.setTitle("Verificar Status da Fila");
        primaryStage.show();
    }
