...
public class TelaComprarPassagemPedestre extends Application {

    private Stage primaryStage;
    private Stage avisoStage;

    public TelaComprarPassagemPedestre() {
    ...
    public void exibirTelaCompraPassagem() {
        ...
        comprarButton.setOnAction(e -> {
            ...
            if (destino != null && horario != null) {
                exibirResumoCompra(destino, horario, quantidadePassageiros);
            } else {
                exibirAviso("Por favor, selecione o destino e o horário.", Color.RED);
            }
        });
        ...
        layout.getChildren().addAll(tituloLabel, destinoComboBox, horarioComboBox, quantidadePassageirosLabel, quantidadePassageirosSpinner, comprarButton, voltarButton);
